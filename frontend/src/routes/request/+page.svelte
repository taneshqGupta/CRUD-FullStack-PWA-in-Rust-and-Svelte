<script lang="ts">
	...
	let newPostCategory = '';
	const newPostType: PostType = 'request'; // Fixed to 'request'
	let newPinCode = '';
	...
	async function handleCreatePost() {
		...
		try {
			...
			success = 'Help request posted successfully! Redirecting to community map...';
			...
			<div class="card-body p-8">
				...
				<form on:submit|preventDefault={handleCreatePost} class="space-y-6">
					...
					<div class="form-control">
						<label for="help-description" class="label">
							<span class="label-text text-lg font-semibold">What do you need help with?</span>
						</label>
						<textarea
							id="help-description"
							name="description"
							class="textarea textarea-bordered textarea-lg h-32"
							placeholder="e.g., I need help moving furniture, learning Spanish, fixing my computer, understanding math..."
					...
					<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
						<div class="form-control">
							<label for="help-category" class="label">
							...
							/>
							<div class="label">
								<span class="label-text-alt">Helps others find your request</span>
							</div>
						</div>
