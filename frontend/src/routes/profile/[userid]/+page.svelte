                    ...
                    <div class="flex flex-col md:flex-row items-center gap-6">
                        <div class="relative">
                            ...
                            {#if profileUpdateLoading}
                                <div class="absolute inset-0 bg-accent-content bg-opacity-50 rounded-full flex items-center justify-center">
                                    <span class="loading loading-infinity loading-md text-accent-content"></span>
                                </div>
                            {/if}
                        </div>
